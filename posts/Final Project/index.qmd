...
# Print str, summary, and first 10 records
str(myDF)
summary(myDF)
head(myDF)
```
...
ggplot(data = subset_to_april_15_2000, aes(x = Date, y = Close)) +
  ...
  scale_color_manual(
    name = "Prices:", # Title for the legend
    values = c("FALSE" = "steelblue", "TRUE" = "red"),
    labels = c("FALSE" = "Increasing", "TRUE" = "Decreasing") # Labels for legend entries
  ) +
  labs(
...
ggplot(data = subset_to_december_2008, aes(x = Date, y = Close)) +
  ...
  scale_color_manual(
    ...
    name = "Prices:" # Set the legend title
  ) +
  labs(
    title = "NVDA Stock Price: Rise and Fall before December 2008",
    subtitle = "Highlighting the pre-peak rise in blue and post-peak decline with a red line",
    caption = "Data source: Onyshchak, O. (2020) - Kaggle.com",
    x = "Date (Year, Month)",
    y = "Closing Stock Price (USD)"
  ) +
